...
terraform {
  required_providers {
    artifactory = {
      source  = "registry.terraform.io/nextlinux/artifactory"
      version = "7.0.2"
    }
  }
}
...
provider "artifactory" {
  //  supply ARTIFACTORY_ACCESS_TOKEN / NEXTLINUX_ACCESS_TOKEN / ARTIFACTORY_API_KEY and ARTIFACTORY_URL / NEXTLINUX_URL as env vars
}
...
resource "artifactory_virtual_alpine_repository" "foo-alpine" {
  ...
  includes_pattern = "com/nextlinux/**,cloud/nextlinux/**"
